export const worksData = {
  ...
  MarineBenabou: {
    ...
    date: "FEBRUARY 2025",
    description:
      "Marine is a mastering engineer based at Manmade Mastering & Cutting studio in Berlin, i developed a professional digital platform that showcase her technical expertise and artistic sensibility.",
  },
  Amouratroi: {
    name: "Amouratroi",
    imgs: [
  ...
  LeChantDesOiseaux: {
    ...
    date: "NOVEMBER 2024 ",
    description:
      "Nestled in the heart of the Cévennes mountains in France, this unique music festival unfolds over six immersive days, with two annual editions. The festival delivers a continuous sonic journey, seamlessly blending non-stop DJ sets with live instrumental performances.",
  },
