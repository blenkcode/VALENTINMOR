export const worksData = {
  Fertile: {
    ...
    description: [
      ...
      "fertile ground – an environment where individuality is, ",
  ...
  CamilleJutel: {
    ...
    description: [
      ...
      "development skills through a photography-inspired design. ",
      "The project  features seamless page transitions, dynamic ",
      " content loading, and responsive layouts that highlight ",
  ...
  MarineBenabou: {
    ...
    description: [
      "Marine is a mastering engineer based at Manmade ",
      "Mastering & Cutting studio in Berlin, i developed a professional  ",
      "digital platform that showcase her technical expertise and",
  ...
  Amouratroi: {
    ...
    description: [
      ...
      "faithfully reflects his distinctive artistic approach. The website ",
      "needed to capture the essence of his photographic work, where",
